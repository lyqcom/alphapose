...
config.DATASET.ROOT = '/home/stu/cfz/'
...
config.TRAIN.CKPT_PATH = "/opt_data/xidian_wks/csl/alphapose/result/ckpt/"
# valid
config.TEST = edict()
...
config.TEST.MODEL_FILE = "multi_train_fastpose_commit_0-270_292.ckpt"
config.TEST.COCO_BBOX_FILE = 'annotations/COCO_val2017_detections_AP_H_56_person.json'
config.TEST.OUTPUT_DIR = 'results/'

#demo
config.detect_image = "/opt_data/xidian_wks/csl/alphapose/images/1.jpg"
config.yolo_image_size = [416, 416]
config.yolo_ckpt = "/mindspore/alphapose/xiangmushi/AlphaPose-pytorch/yolov3.ckpt"
config.fast_pose_ckpt = "/opt_data/xidian_wks/csl/alphapose/multi_train_fastpose_commit_0-270_292.ckpt"
config.yolo_threshold = 0.1  # confidence under ignore_threshold means no object when training
